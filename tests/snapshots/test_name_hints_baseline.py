...
CORPUS: list[str] = [
    ...
    "zip_file_size",
    "date_created",
    "date_updated",  # SHOULD match date hints (these are dates)
    "address_count",
    "address_id",
    "card_count",
    "card_image",
...
def _build_matrix() -> dict[str, dict[str, bool]]:
    ...
    return {det: {hdr: hits_name_hint(det, hdr) for hdr in headers} for det in detector_ids}
