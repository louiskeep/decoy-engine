...
def sample_fixed_width_file():
    ...
    with open(fw_path, "w") as f:
        ...
        f.write(
            "CUST003   Alice          Johnson         alice.j@example.com             555-9012 \n"
        )
        f.write(
            "CUST004   Bob            Brown           bob.brown@example.com           555-3456 \n"
        )
        f.write(
            "CUST005   Carol          Williams        carol.w@example.com             555-7890 \n"
        )
...
def sample_generator_config():
    ...
    config = {
        "generator_settings": {"seed": 42, "output_directory": OUTPUT_DIR, "chunk_size": 1000},
        "tables": [
            {
                "name": "customers",
                "rows": 10,
...
def mock_logger():
    ...
    logger_config = {"level": "debug", "console": True, "verbose": True}
