...
class TestEmptyParentPool:
    def test_empty_parent_pool_surfaces_as_node_error(
        self, all_null_parent_csv, tmp_path, ctx
    ):
...
class TestParentOpFailure:
    def test_parent_failure_prevents_child_from_running(
        self, tmp_path, ctx
    ):
        ...
        cfg = {
            ...
            "nodes": [
                {"id": "src_1", "kind": "source.file",
                 "config": {"path": str(tmp_path / "nope.csv"),
                            "format": "csv"}},
                {"id": "mask_1", "kind": "mask",
                 "config": {"columns": {"id": {"strategy": "hash"}}}},
                {"id": "tgt_1", "kind": "target.file",
