...
def test_all_lists_every_public_name():
    expected = {
        ...
        # job_seed_for_config: the CLI vault-inspector's seed helper (S5
        # job-seed export); public per the plan module's __all__.
        "job_seed_for_config",
        ...
        "LicenseVerifier",
        "validate_config",
        # S22-CL-V1GRAPHRUNNER (2026-05-30): removed validate_graph,
        # validate_graph_full, normalize_config, run_graph, preview_graph,
        # RunResult, PreviewResult. V1 graph public surface retired.
        "VALIDATION_CODES",
        "ValidationMessage",
        "ValidationResult",
        "run_storm",
