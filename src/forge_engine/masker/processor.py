# forge_engine/masker/processor.py
"""
Data processing logic for the forge_engine masker.
    ...
    def _evaluate_conditions(
        ...
        for cond in conditions:
            ...
            if col not in df.columns:
                self.logger.warning(f"Condition column '{col}' not found in data — condition skipped")
                continue
