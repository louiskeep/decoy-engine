...
def cheap_admission(
    *,
    ...
    if resolved_substrate != "pandas":
        ...
        # route only. A non-pandas substrate would run a different adapter and
        # stamp its own provenance telemetry (executed_substrate, boundary
        # conversion timings), so admitting it
