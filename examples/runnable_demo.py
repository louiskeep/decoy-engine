...
members = pd.DataFrame(
    {
        ...
        "last_name": ["Reed", "Shaw", "Tran", "Underwood", "Vance", "West", "Xu", "York", "Zane", "Ames"],
    ...
    "tables": [
        {
            ...
            "columns": [
                ...
                {"name": "ssn", "strategy": "fpe", "namespace": "ssn_space",
                 "provider_config": {"charset": "digits", "preserve_separators": True}},
                {"name": "mrn", "strategy": "fpe", "deterministic": True, "namespace": "mrn_space",
                ...
                {"name": "legacy_account", "strategy": "hash", "namespace": "account_vault",
                 "vault": True},
            ],
        },
        {
