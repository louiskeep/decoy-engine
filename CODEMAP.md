...
| Out-of-core batch-streaming FK execution (opt-in, SC1) | `src/decoy_engine/execution/out_of_core/` (`run_fk_out_of_core` entry point); not auto-routed; uses DuckDB spill and staged parent-key relations for bounded batch passes |
